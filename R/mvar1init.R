...
##' given by the \code{Trait} argument with a names attribute that
##' matches \code{Traits}(see below)
##' @param spatial a list of character strings of the model for the spatial
##' effects
##' @param Traits a vaector of character strings giving the name of the traits
...
##'
mvar1init <-
function(gam, init.var, spatial=list("Run", "Range"), Traits=NULL,
                      n.trait=length(init.var)) {
